...
public class ExoPlayerManager {
    ...
    private ExoPlayerManager(final Context mContext) {
        ...
        dataSourceFactory = new DefaultDataSourceFactory(mContext, Util.getUserAgent(mContext, "OnlineVideoPlayer"), BANDWIDTH_METER);
        ...
        mPlayer.addListener(new Player.EventListener() {
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                ...
                if (playbackState == 4 && mPlayList != null && playlistIndex + 1 < mPlayList.size()) {
                    ...
                    playStream(mPlayList.get(playlistIndex),playlistIndex,mContext);
    ...
    public void playStream(String urlToPlay,int position,Context mContext) {
        uriString = urlToPlay;
        Uri mp4VideoUri = Uri.parse(uriString);
        ...
        mPlayer.seekTo(new DBHelper(mContext).getLastTime(VideoPlayer.listData.get(position).getId()));
    ...
    public void setPlaylist(ArrayList<String> uriArrayList, Integer index, CallBacks.playerCallBack callBack,Context mContext) {
        mPlayList = uriArrayList;
        playlistIndex = index;
        listner = callBack;
        playStream(mPlayList.get(playlistIndex),index,mContext);
    }
